...
public class Topic4_Methods {
    ...
    */
    ...
    /* default ==> Default: When no access modifier is specified for a class, method, or data member –
    It is said to be having the default access modifier by default.
    The methods which are not declared using any access modifiers, They have default access modifiers,
    which means only accessible within the same package.
    */
}
